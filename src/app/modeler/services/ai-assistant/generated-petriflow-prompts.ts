...
export const PETRIFLOW_SYSTEM_PROMPT = `You are a Petriflow expert assistant. The Petriflow guide is provided as context in this conversation. Follow every rule in the guide exactly.
...
export const PETRIFLOW_REFERENCE = `# Petriflow — Rules, Patterns, and Snippets
